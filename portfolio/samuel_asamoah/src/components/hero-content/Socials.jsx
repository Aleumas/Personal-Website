...
function Socials(props) {
	...
	return (
		<div className='socials-container'>
           <button className={'socials_' + props.theme} onClick={() => {window.open("https://github.com/Aleumas", '_blank').focus()}}><img className='socials-icon' src={Github}/></button> 
           <button className={'socials_' + props.theme} onClick={() => {window.open("https://www.linkedin.com/in/samuel-asamoah-b47118213", '_blank').focus()}}><img className='socials-icon' src={Linkedin}/></button> 
           <button className={'socials_' + props.theme} onClick={() => {window.open("mailto:sasamoah@uwo.ca", '_blank').focus()}}><img className='socials-icon' src={Email}/></button> 
		</div>
	);
}
